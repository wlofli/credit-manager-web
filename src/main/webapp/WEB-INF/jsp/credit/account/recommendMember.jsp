...
<div class="grzx_nr1">
<ul>
<li><a href="${ctx }/credit/user/recommend/member" class="hit">推荐普通会员</a></li>
<li><a href="${ctx }/credit/user/recommend/manager">推荐信贷经理</a></li>
</ul>
</div>
<div class="news_cx">
<span>注册时间：</span>
<sf:form action="${ctx }/credit/user/recommend/member" method="post" id="searchForm" commandName="search">
...
<p:page url="${ctx }/credit/user/recommend/member" pageData="${page}"></p:page>
