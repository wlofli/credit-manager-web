...
<title>信贷经理-客户问答-新越网平台问题-热门问题</title>
...
<body>
		...
		<div class="right">
			...
			<div class="grzl">
				...
				<div class="grzx_nr">
					...
					<div class="news_nr">
						<div class="news_btn1">
							<ul class="wd_tab" id="menu">
								<li><a href="javascript:void(0)" onclick="document.location.href='${ctx}/credit/answerctr/xterrace?index=1'"><span>少回答问题</span></a></li>
								<li class="hit"><a href="javascript:void(0)" onclick="document.location.href='${ctx}/credit/answerctr/xposs?index=1'"><span>热门问题</span></a></li>
					...
					<p:page url="${ctx }/credit/answerctr/xposs" pageData="${poss}"></p:page>
	...
	<script type="text/javascript">
		function saveAnswer(node){
			$.ajax({
				...
				success:function(data){
					if(data == 'success'){
						alert("保存成功");
						document.location.href='${ctx}/credit/answerctr/xposs';
					}else{
						alert("保存失败");
					}
				}
		...
		function xtarget(event , questid){
			event.stopPropagation();
			document.location.href="${ctx }/credit/answerctr/showAnswer?questid="+questid+"&index=1";
		}
	</script>
</body>
</html>