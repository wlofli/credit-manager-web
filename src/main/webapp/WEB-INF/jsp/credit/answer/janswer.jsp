		...
		<div class="right">
			...
			<div class="grzl">
				...
				<div class="grzx_nr">
					...
					<p:page url="${ctx }/credit/answerctr/showAnswer?index=2&questid=${question.id }" pageData="${pageanswer}"></p:page>
	...
	function saveAnswer(node){
		$.ajax({
			...
			success:function(data){
				if(data == 'success'){
					alert("保存成功");
					document.location.href='${ctx}/credit/answerctr/showAnswer?index=2&questid='+node;
				}else{
					alert("保存失败");
				}
			}
