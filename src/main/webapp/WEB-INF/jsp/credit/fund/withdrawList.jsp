...
<tr>
<td colspan="1"><fmt:formatDate value="${list.withdrawTime }" pattern="yyyy-MM-dd"/></td>
<td colspan="1">${list.id }</td>
<td colspan="1">${list.withdrawType }</td>
<td colspan="1">${list.withdrawAmount }</td>
...
<p:page url="${ctx }/credit/user/withdraw/list" pageData="${page}"></p:page>
