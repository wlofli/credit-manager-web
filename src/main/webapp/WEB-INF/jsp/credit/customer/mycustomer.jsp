...
<div class="grzl">
<div class="grzx_bt">
<span>领取客户</span><span class="khgl_zs">正确反馈订单信息，可以增加您的平台积分</span><a href="javascript:show2()">查看详情> </a>
</div>
<div class="khgl_top">
<div class="khgl_top1">
...
<div class="gjsx">
<sf:form action="${ctx }/order/mycustomer" method="post" commandName="searchCustomer" id="searchForm">
...
<span class="xzcp_bt">获客来源：</span>
<sf:select cssClass="xzcp_s1" path="orderType">
		<sf:option value="">请选择</sf:option>
		<sf:options items="${ordertypelist }" itemLabel="value" itemValue="key"/>
</sf:select>
...
<p:page url="${ctx }/order/mycustomer" pageData="${page}"></p:page>
